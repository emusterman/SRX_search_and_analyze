...
def search_and_analyze_base(search_args=[],
    ...
    bkg = gaussian_filter(data, sigma=10)
    data_bkg = data - bkg
    roi_mask = data_bkg >= threshold_otsu(data_bkg)
...
def Piedmont_testing():
    ...
    # def search_prep():
    #     en_read = energy.energy.readback.get()
    #     if en_read > 1e3:
    #         en_read /= 1e3
        
    #     if np.abs(en_read - 7) > 0.5:
    #         yield from mov(energy, 7)
    #         # yield from mov(attenuators.Al_100um, 1)
    #         # yield from peakup()
    ...
    # High res map and spectroscopy - last function
    ...
    #                                                      point_method='com',
    #                                                      analysis_args=[[X-50, X-10, X+25, X+100],
    #                                                                     [2, 1, 3],
    #                                                                     1])
    # def sub_sub_search(*args):
    #     yield from search_and_analyze_base(
    ...
    # Sub_function - correct alignment
    def sub_search(*args):
    ...
    yield from search_and_analyze_base(search_args=[3100, 3400, 101, -4900, -4600, 101, 0.1],
                                    #    search_prep_function=search_prep,
                                       search_function=coarse_scan_and_fly,
                                       search_motors=[nano_stage.topx, nano_stage.y],
                                    #    search_scan_id=174275,
                                       max_num_rois=20,
                                    #    data_cutoff=1e3,
                                       data_key='xs_fluor',
                                       ...
                                       feature_type='points',
                                       point_method='com',
                                       analysis_args=[-7.5, 7.5, 21, -7.5, 7.5, 21, 0.05],
